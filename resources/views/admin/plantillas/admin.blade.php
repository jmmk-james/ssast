...
<body class="theme-red">
    ...
    <div class="content">
        <ul class="main-menu">
            <li class="menu-item active">
              <a href="{{route('ssast')}}" class="menu-link">
                <span class="icon ti-home"></span>
                <span class="caption">Home</span>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('formularioSorteo')}}" class="menu-link">
                <span class="icon ti-user"></span>
                <span class="caption">Sortear</span>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{route('listaGanador')}}" class="menu-link">
                <span class="icon ti-file"></span>
                <span class="caption">Ganadores</span>
              </a>
            </li>
          </ul>
        </div>
  ...
  <script src="{{asset('assets/js/sorteo.js')}}"></script>
